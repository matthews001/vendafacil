...
## Passo 8 — Painel de pedidos em tempo real

- Assinatura Realtime por loja ativa, sem misturar pedidos de outra loja.
- Novos pedidos recebem alerta visual, popup opcional e som opcional.
- Atualizações de status recarregam o quadro operacional com debounce para evitar travamentos.
- A assinatura só é criada após o identificador da loja estar disponível.
- Nenhuma alteração foi feita nas RPCs de balcão, mesas ou entrega.
