...
if (!(html.includes('PDV · PASSO 7 DE 12') || html.includes('PDV · PASSO 8 DE 12') || html.includes('PDV · PASSO 9 DE 12')) || !html.includes('vf-pdv-console') || !html.includes('vf-pdv-workspace')) throw new Error('Layout operacional do PDV não foi encontrado.');
