...
begin
  ...
  insert into public.commerce_orders (
    business_id, public_code, buyer_name, buyer_phone, notes, subtotal_amount, total_amount, status, paid_at,
    ...
    nullif(trim(coalesce(p_notes, '')), ''), v_subtotal, v_total, v_status,
